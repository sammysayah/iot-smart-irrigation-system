        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div class="w-full md:w-1/2 lg:w-2/5">
                <div class="glass-card p-8 card-hover animate-slide-in">
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-600 mt-2">Sign in to your Smart Irrigation account</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" id="loginForm">
                        ...
                        <button type="submit" class="btn-primary w-full inline-flex items-center justify-center px-6 py-3 text-white rounded-lg font-medium mb-4">
            ...
            <div class="w-full md:w-1/2 lg:w-3/5 mt-8 md:mt-0">
                <div class="glass-card p-8 card-hover animate-slide-in" style="animation-delay: 0.1s">
                    <h3 class="text-2xl font-bold text-gray-800 mb-6">Smart Irrigation Benefits</h3>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="text-lg font-semibold text-gray-800">Weather-Adaptive Watering</h4>
                                <p class="text-gray-600 mt-1">Automatically adjusts irrigation based on real-time weather conditions.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="text-lg font-semibold text-gray-800">Detailed Analytics</h4>
                                <p class="text-gray-600 mt-1">Track water usage, soil moisture levels, and plant health metrics.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="text-lg font-semibold text-gray-800">Smart Automation</h4>
                                <p class="text-gray-600 mt-1">AI-powered scheduling that learns your garden's unique needs.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="text-lg font-semibold text-gray-800">Leak Detection</h4>
                                <p class="text-gray-600 mt-1">Instant alerts for unusual water flow patterns and potential leaks.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        <div class="grid grid-cols-3 gap-4 text-center">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-gray-600">Yield Increase</div>
                            </div>
                            <div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (sessionStatus) {
                setTimeout(() => {
                    ...
                    setTimeout(() => sessionStatus.remove(), 300);
                }, 5000);
            }
        });
    </script>
